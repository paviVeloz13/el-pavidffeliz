...
from .operations.pdf_edit import handle_apply_annotations
...
OPERATIONS: dict[str, OperationHandler] = {
    ...
    "pdf.apply_annotations": handle_apply_annotations,
}
